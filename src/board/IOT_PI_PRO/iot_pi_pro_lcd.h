...
**
** 参 考 文  件: stm32h750b_discovery_lcd.h
*********************************************************************************************************/

#ifndef IOT_PI_PRO_LCD_H
#define IOT_PI_PRO_LCD_H
...
#define LCD_LAYER_0_ADDRESS                 BSP_CFG_FB_LAYER1_ADDR      /* 0x30000000 - 0x3001FFFF      */
#define LCD_LAYER_1_ADDRESS                 BSP_CFG_FB_LAYER2_ADDR      /* 0x30020000 - 0x3003FFFF      */

#define LCD_ORIENTATION_PORTRAIT            0x00U                       /* Portrait orientation   (|)   */
#define LCD_ORIENTATION_LANDSCAPE           0x01U                       /* Landscape orientation  (-)   */

/*********************************************************************************************************
  LCD debug defines
*********************************************************************************************************/

#define LCD_TEST_FRAME_BUFFER_EN            0U
#define LCD_TEST_FRAME_BUFFER_ADDR          LCD_LAYER_0_ADDRESS

/*********************************************************************************************************
  LCD Pixel Size & Timing defines
*********************************************************************************************************/

#define LCD_DEFAULT_WIDTH                   ((uint16_t)480)             /* LCD PIXEL WIDTH              */
#define LCD_DEFAULT_HEIGHT                  ((uint16_t)272)             /* LCD PIXEL HEIGHT             */

#define LCD_TIMING_HSYNC                    ((uint16_t)4)               /* Horizontal synchronization   */
#define LCD_TIMING_HBP                      ((uint16_t)43)              /* Horizontal back porch        */
#define LCD_TIMING_HFP                      ((uint16_t)8)               /* Horizontal front porch       */
#define LCD_TIMING_VSYNC                    ((uint16_t)4)               /* Vertical synchronization     */
#define LCD_TIMING_VBP                      ((uint16_t)12)              /* Vertical back porch          */
#define LCD_TIMING_VFP                      ((uint16_t)8)               /* Vertical front porch         */

/*********************************************************************************************************
  LCD special pins
*********************************************************************************************************/

#define LCD_DISP_EN_PIN                     GPIO_PIN_10                 /* LCD display enable pin       */
...
#define LCD_BL_CTRL_PIN                     GPIO_PIN_9                  /* Back-light control pin       */
...
/* Compatible macro definition */
#define LCD_COLOR_WHITE                       LCD_COLOR_RGB565_WHITE
#define LCD_COLOR_BLACK                       LCD_COLOR_RGB565_BLACK
#define LCD_OK                                BSP_ERROR_NONE
...
#define BSP_LCD_LayerConfig_t            MX_LTDC_LayerConfig_t         /* Special lcd layer config type */
...
/* LCD generic APIs: Draw operations. This list of APIs is required for lcd gfx utilities */
