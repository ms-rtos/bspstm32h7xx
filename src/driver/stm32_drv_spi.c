...
static void __stm32_spi_prescaler_set(SPI_TypeDef *instance, ms_uint32_t baud_rate, ms_uint32_t *prescaler)
{
    ...
    if (instance == (SPI_TypeDef *)SPI1_BASE || instance == (SPI_TypeDef *)SPI2_BASE || instance == (SPI_TypeDef *)SPI3_BASE) {
        PLL1_ClocksTypeDef PLL1_Clocks;
        HAL_RCCEx_GetPLL1ClockFreq(&PLL1_Clocks);
        div = __DIV_ROUND_UP(PLL1_Clocks.PLL1_Q_Frequency, baud_rate);
    } else {
